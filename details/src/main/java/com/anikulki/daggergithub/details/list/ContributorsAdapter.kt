package com.anikulki.daggergithub.details.list

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import coil.api.load
import com.anikulki.daggergithub.details.databinding.ItemContributorsBinding
...
class ContributorsAdapter : RecyclerView.Adapter<ContributorsAdapter.ContributorViewHolder>() {
    ...
    class ContributorViewHolder(private val binding: ItemContributorsBinding) :
